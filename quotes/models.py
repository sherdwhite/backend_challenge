...
from django.db.models import CharField, IntegerField, PositiveIntegerField, DecimalField, DateField, BooleanField
from model_utils.models import TimeStampedModel


class Quote(TimeStampedModel):
    quote_number = PositiveIntegerField(db_index=True)
